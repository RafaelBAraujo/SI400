...
public class RaceAnalysisScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblStartingRisk = new javax.swing.JTable();
        ...
        tblStartingRisk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane12.setViewportView(tblStartingRisk);
        if (tblStartingRisk.getColumnModel().getColumnCount() > 0) {
            tblStartingRisk.getColumnModel().getColumn(0).setResizable(false);
        }
    ...
    public void loadDataIntoTables(){
        ...
        DefaultTableModel modelStartRisk = (DefaultTableModel) tblStartingRisk.getModel();
        ...
        baseController.displayRace(raceKey, modelPractice, modelLaps, modelPistops, modelCar, modelCarCarac, modelInitialWear, modelFinalWear, modelQualifyings,
                                   modelQSetups, modelForecast, modelRisks, modelStartRisk);
    ...
    private javax.swing.JTable tblStartingRisk;
