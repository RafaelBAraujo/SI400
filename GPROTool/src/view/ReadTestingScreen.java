...
public class ReadTestingScreen extends javax.swing.JFrame {
    ...
    public ReadTestingScreen(GproToolController controller) {
        ...
        initComponents();
        centerFrame();
        initSelfListeners(this.baseController, this, this.prgProgress, this.baseController);
    }
    ...
    private void initSelfListeners(GproToolController control, javax.swing.JFrame window, javax.swing.JProgressBar bar, GproToolController controller) {
        ...
        WindowListener taskStarterWindowListener = new WindowListener() {
            ...
            public void windowClosing(WindowEvent e) {
                Thread.currentThread().interrupt();
                //MainScreen ms = new MainScreen(control);
                //ms.setVisible(true);
            }
...
class readTesting extends SwingWorker<Void, Void> {
    ...
    public readTesting(javax.swing.JFrame window, javax.swing.JProgressBar b, javax.swing.JTextPane txp, GproToolController controller) {
        this.bar = b;
        this.txp = txp;
    ...
    protected Void doInBackground() throws Exception {
        ...
        this.baseController.readTesting(this.bar, this.txp, this.window);
